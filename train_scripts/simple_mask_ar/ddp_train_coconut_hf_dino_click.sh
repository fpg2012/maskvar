#!/bin/bash
# Train click-conditioned SimpleMaskAR on COCONut HF dataset.
# Initializes from an already trained non-click SimpleMaskAR checkpoint.
#
# Usage:
#   bash train_scripts/simple_mask_ar/ddp_train_coconut_hf_dino_click.sh [N_NODE] [OUTDIR] [VQVAE_CKPT] [AR_CKPT] [MASTER_PORT]
#
# Example:
#   bash train_scripts/simple_mask_ar/ddp_train_coconut_hf_dino_click.sh 4 \
#     out/ddp_simple_mask_ar_coconut_click_ep5 \
...
N_NODE=${1:-4}
OUTDIR=${2:-out/ddp_simple_mask_ar_coconut_click_ep5}
