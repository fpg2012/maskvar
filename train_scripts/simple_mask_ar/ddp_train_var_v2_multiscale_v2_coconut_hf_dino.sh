#!/bin/bash
# Train SimpleMaskVARV2 on top of a frozen multiscale V2 SimpleMaskVqvae.
# Usage:
#   bash train_scripts/simple_mask_ar/ddp_train_var_v2_multiscale_v2_coconut_hf_dino.sh [N_NODE] [OUTDIR] [VQVAE_CKPT] [MASTER_PORT]

N_NODE=${1:-4}
OUTDIR=${2:-out/ddp_simple_mask_var_v2_multiscale_v2_coconut_ep10}
