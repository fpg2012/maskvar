...
from maskvar.models.simple_ar import SimpleAR
...
class SimpleARTrainer:
    ...
    def __init__(
        ...
        # models
        self.simple_ar: SimpleAR = simple_ar
        self.vqvae: VQVAE_Single = vqvae

        # optimizer
        self.optimizer = torch.optim.AdamW(simple_ar.parameters(), lr=lr)
    ...
    def compile_model(self):
        self.simple_ar.to(self.device)
        self.vqvae.to(self.device)
        self.simple_ar = torch.compile(self.simple_ar)
    ...
    def train_step(self, image, image_embed_sam, single_mask_normalized, single_mask):
        ...
        logits = self.simple_ar(gt_idx_flat)[:, :-1, :]
    ...
    def eval(self, num_iters: int):
        ...
        for i, (image, image_embed_sam, single_mask_normalized, single_mask) in enumerate(val_dataloader):
            ...
            logits = self.simple_ar(gt_idx_flat)
