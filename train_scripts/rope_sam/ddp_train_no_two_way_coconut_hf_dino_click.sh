#!/bin/bash
# Train NoTwoWayRopeSAM on COCONut HF dataset with DINO v3 image features and click prompts.
#
# Usage:
#   bash train_scripts/rope_sam/ddp_train_no_two_way_coconut_hf_dino_click.sh [N_NODE] [OUTDIR] [MASTER_PORT] [INIT_CKPT]

N_NODE=${1:-4}
OUTDIR=${2:-out/ddp_rope_sam_no_two_way_coconut_hf_dino_click}
